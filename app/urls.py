...
urlpatterns = [
    ...
    path('clientes/<int:client_id>/enderecos/adicionar/', views.adicionar_endereco_cliente_staff, name='adicionar_endereco_cliente_staff'),
    path('clientes/<int:client_id>/enderecos/<int:endereco_id>/excluir/', views.excluir_endereco_cliente_staff, name='excluir_endereco_cliente_staff'),
    path('clientes/<int:client_id>/enderecos/<int:endereco_id>/editar/', views.editar_endereco_cliente_staff, name='editar_endereco_cliente_staff'),
   ...
   path('sugestoes-inteligentes/adicionar-ao-carrinho/', views.adicionar_sugestoes_ao_carrinho, name='adicionar_sugestoes_ao_carrinho'),
    ...
    path('carrinho/atualizar-qtd/', views.atualizar_item_qtd, name='atualizar_item_qtd'),
    path('carrinho/remover-ajax/<int:product_id>/', views.remover_item_ajax, name='remover_item_ajax'),
